...
- **Option 1 (recommended):** Delete or rename config.yml and restart, this resets all Geyser ports to their defaults. Also can fix config errors. You do not need to make any config edits after this.
